  ...
  if ( ! rfid.PICC_IsNewCardPresent() || ! rfid.PICC_ReadCardSerial()) {
    ...
    if ( ! newKey) {
      ...
      if (plainData.length() > 0) {
        ...
        Serial.print("esch256( ");
        Serial.print(to_hex(decimalData, d_len));
        Serial.print(" ) = ")
        Serial.print(to_hex(dig0, sizeof(dig0)));
        Serial.println("");
      }
      ...
      mfrcKeypadReadings.Dig[esch256::DIGEST_LEN] = dig0[esch256::DIGEST_LEN];
